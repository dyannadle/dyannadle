...
const LiveBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-20">
      ...
      {/* --- GEOMETRIC SHAPES (Reference Match - MASSIVE SIZES & BOLD) --- */}

      {/* 1. Cyan Wireframe Sphere (Top Left) - HUGE */}
      <div className="absolute left-[-10%] top-[5%] opacity-70 animate-spin-slow">
        <svg width="900" height="900" viewBox="0 0 200 200" className="w-[80vw] h-[80vw] md:w-[900px] md:h-[900px]">
          <defs>
          ...
          <g stroke="url(#cyanGrad)" strokeWidth="3" fill="none">
      ...
      <div className="absolute right-[-5%] bottom-[-10%] opacity-60 animate-spin-slow-reverse">
        <svg width="700" height="700" viewBox="0 0 200 200" className="w-[70vw] h-[70vw] md:w-[700px] md:h-[700px]">
          <g stroke="url(#cyanGrad)" strokeWidth="3" fill="none">
      ...
      <div className="absolute left-[15%] top-[30%] opacity-70 mix-blend-screen animate-float-slow">
        <div className="w-[1100px] h-[220px] rounded-[100%] border-4 border-orange-500/60 shadow-[0_0_25px_rgba(249,115,22,0.4)] transform -rotate-[30deg]" />
      </div>

      {/* 4. Orange Ring (Smaller, Tilted) - Right - LARGE */}
      <div className="absolute right-[5%] top-[15%] opacity-60 mix-blend-screen animate-float">
        <div className="w-[750px] h-[150px] rounded-[100%] border-4 border-orange-400/50 transform rotate-[15deg]" />
      </div>

      {/* 5. Orange Polyhedron (Now Large) */}
      <div className="absolute right-[5%] top-[40%] opacity-50 animate-spin-slow">
        <svg width="400" height="400" viewBox="0 0 100 100">
          <rect x="25" y="25" width="50" height="50" fill="none" stroke="#f97316" strokeWidth="3" transform="rotate(45 50 50)" />
        </svg>
      </div>
